package SortingAlgorithms.LBP.ArrayProblems.Hard.MaximumProfitBuyingSellingShare;

public class Profit {

    // Returns maximum profit with two transactions on a
    // given list of stock prices,price[0..n-1]
