package SortingAlgorithms.LBP.SortingProblems.Medium.SortArrayByCountofSetBits;
...
class GFG {
    ...
    static void insertionSort(int arr[], int aux[], int n)
    {
        for (int i = 1; i < n; i++) {
            ...
            // Move elements of arr[0..i-1] and aux[0..i-1],such that elements of aux[0..i-1] are greater
            // than key1, to one position ahead of their current position
