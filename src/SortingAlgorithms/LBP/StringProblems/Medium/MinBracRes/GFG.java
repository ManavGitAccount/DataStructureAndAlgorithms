package SortingAlgorithms.LBP.StringProblems.Medium.MinBracRes;
...
class GFG {
    ...
    // Method count minimum reversal for making an expression balanced. Returns -1 if expression cannot be balanced
