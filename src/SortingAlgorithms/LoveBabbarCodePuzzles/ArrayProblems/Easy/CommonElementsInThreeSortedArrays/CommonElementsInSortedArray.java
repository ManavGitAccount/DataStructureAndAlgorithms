package SortingAlgorithms.LoveBabbarCodePuzzles.ArrayProblems.Arrays.CommonElementsInThreeSortedArrays;
...
public class CommonElementsInSortedArray {
    ...
    {
        CommonElementsInSortedArray ob = new CommonElementsInSortedArray();
